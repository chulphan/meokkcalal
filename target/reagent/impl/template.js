...
var G__1344 = o;
goog.object.set(G__1344,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__1348 = o;
goog.object.set(G__1348,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__1352 = props;
var G__1352__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1352,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1352);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1352__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__1353 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1353,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__1353;
}
})(),id_class);
...
var G__1354 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1354) {
case (0):
...
var vec__1356 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1356,(0),null);
var id = cljs.core.nth.call(null,vec__1356,(1),null);
var className = cljs.core.nth.call(null,vec__1356,(2),null);
...
var temp__5808__auto___1359 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___1359 == null)){
} else {
var key_1360 = temp__5808__auto___1359;
(jsprops.key = key_1360);
}
...
var temp__5808__auto___1361 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___1361 == null)){
} else {
var key_1362 = temp__5808__auto___1361;
(jsprops.key = key_1362);
}
...
var temp__5808__auto___1363 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___1363 == null)){
} else {
var key_1364 = temp__5808__auto___1363;
(jsprops.key = key_1364);
}
...
var temp__5808__auto___1365 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
...
var temp__5808__auto___1367 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__1369_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__1369_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__1370 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__1370,(0),null);
var derefed = cljs.core.nth.call(null,vec__1370,(1),null);
...
break;
default:
var G__1375 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__1376 = compiler;
v = G__1375;
compiler = G__1376;
continue;
...
var G__1377 = tag;
var G__1377__$1 = (((G__1377 instanceof cljs.core.Keyword))?G__1377.fqn:null);
switch (G__1377__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template1380 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template1380 = (function (opts,id,fn_to_element,parse_fn,meta1381){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta1381 = meta1381;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template1380.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_1382,meta1381__$1){
var self__ = this;
var _1382__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template1380(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta1381__$1));
}));

(reagent.impl.template.t_reagent$impl$template1380.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_1382){
var self__ = this;
var _1382__$1 = this;
return self__.meta1381;
}));

(reagent.impl.template.t_reagent$impl$template1380.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template1380.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template1380.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template1380.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template1380.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template1380.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta1381","meta1381",591933495,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template1380.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template1380.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template1380");

(reagent.impl.template.t_reagent$impl$template1380.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write.call(null,writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template1380");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template1380.
 */
reagent.impl.template.__GT_t_reagent$impl$template1380 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template1380(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta1381){
return (new reagent.impl.template.t_reagent$impl$template1380(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta1381));
});

}

return (new reagent.impl.template.t_reagent$impl$template1380(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
